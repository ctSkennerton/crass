...
namespace crispr {
    ...
    public:
        ...
        int setNodeAttribute(Agnode_t * node ,char * attrName, char * attrValue);

        int setGraphAttribute(char * attrName, char * attrValue);
 
        int setEdgeAttribute(Agedge_t * edge ,char * attrName, char * attrValue);
