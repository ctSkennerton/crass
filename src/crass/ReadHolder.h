...
namespace crass {
    ...
    public:
        ...
        ReadHolder(std::string s, std::string h): RH_LastDREnd(0), 
        ...
        int getAverageSpacerLength(void);
    ...
    private:
        ...
        crispr::RepeatArray<unsigned int> RH_StartStops;          // start stops for DRs, (must be even in length!)
