...
#define gvKeyGroupHeader(stream, cLUSTERnUMBER, gROUPnAME){ \
stream<<"\t"<<CRASS_DEF_DEFAULT_SUB_GRAPH_TYPE<<" cluster_"<<cLUSTERnUMBER<<"\t{\n\t\t\""<<gROUPnAME<<"\" [ fillcolor = \"white\" shape = \"record\" label =<<table border=\"0\" cellborder=\"0\" cellpadding=\"0\" bgcolor=\"white\"><tr><td>"<<gROUPnAME<<"</td></tr>";\
}
