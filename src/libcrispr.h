...
//bool update_word_bm(int start_pos, int &search_begin, int &start, const options &opts, DirectRepeat &dr);
...
void cutSpacerKmers( string &read, lookupTable &inputLookup, const options &opts);
